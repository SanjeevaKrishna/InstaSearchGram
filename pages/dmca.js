...
export default function DMCA() {
  return (
    <>
      <Head>
        <title>DMCA Policy — InstaSearch</title>
      </Head>
      <Navbar />
      <main style={{ maxWidth: 700, margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{ color: 'var(--text-dim)', lineHeight: 1.9, fontSize: 15 }}>
          ...
          <p style={{ marginBottom: 16 }}>InstaSearch respects the intellectual property rights of others. We comply with the Digital Millennium Copyright Act (DMCA) and other applicable intellectual property laws.</p>
          ...
          <p style={{ marginBottom: 16 }}>If you believe that your copyrighted work has been copied or used on InstaSearch in a way that constitutes copyright infringement, please notify our designated copyright agent with the following details:</p>
          ...
          <p>Upon receiving a valid DMCA notification, InstaSearch will take immediate action to investigate and, if necessary, remove or disable access to the infringing material. We will also notify the user who posted or is associated with the material, allowing for counter-notifications under applicable laws.</p>
        </div>
      </main>
    </>
  )

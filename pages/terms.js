...
export default function Terms() {
  return (
    <>
      <Head>
        <title>Terms of Service — InstaSearch</title>
      </Head>
      <Navbar />
      <main style={{ maxWidth: 700, margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{ color: 'var(--text-dim)', lineHeight: 1.9, fontSize: 15 }}>
          ...
          <p style={{ marginBottom: 16 }}>Welcome to InstaSearch. By accessing our website, you agree to comply with and be bound by these Terms of Service. If you do not agree, please do not use our services.</p>
          ...
          <p style={{ marginBottom: 16 }}>InstaSearch is an information and search directory for public social media profiles. You agree to use the site only for lawful, personal, and non-commercial purposes.</p>
          ...
          <p style={{ marginBottom: 16 }}>All trademarks, logos, content, and code on InstaSearch are the property of their respective owners. Instagram profile pictures, reels, posts, and names referenced belong to the respective creators and Instagram (Meta Platforms, Inc.). We claim no ownership over Instagram content.</p>
          ...
          <p style={{ marginBottom: 16 }}>The materials on InstaSearch are provided on an 'as is' basis. We make no warranties, expressed or implied, regarding the accuracy, completeness, or reliability of the information.</p>
          ...
          <p style={{ marginBottom: 16 }}>In no event shall InstaSearch or its developers be liable for any damages arising out of the use or inability to use the materials on the website.</p>

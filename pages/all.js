...
const formatCount = (num) => {
  ...
  if (val >= 1000000000) return `${(Math.floor(val / 100000000) / 10).toString().replace(/\.0$/, '')}B`
  if (val >= 1000000) return `${(Math.floor(val / 100000) / 10).toString().replace(/\.0$/, '')}M`
  if (val >= 1000) return `${(Math.floor(val / 100) / 10).toString().replace(/\.0$/, '')}K`
  return val.toString()
}

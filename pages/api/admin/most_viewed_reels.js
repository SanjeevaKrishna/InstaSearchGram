...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST') {
      const { title, photo_url, instagram_link, order_index, creator_name, creator_photo_url, followers_text, views_text, created_at, description, why_notable } = req.body
    ...
    if (req.method === 'PUT') {
      const { id, title, photo_url, instagram_link, order_index, creator_name, creator_photo_url, followers_text, views_text, created_at, description, why_notable } = req.body
